...
function showModeSelect(){
  ...
  el.innerHTML = `
    <button class="modeSelectBtn" id="btnGoMethods">
      <div class="modeSelectName"><span class="part1">METH</span><span class="part2">ODS</span></div>
...
function wire(){
  ...
  document.addEventListener("keydown",(e)=>{
    ...
    if(e.key==="F1"){
      e.preventDefault();
      const btnS=document.getElementById("btnSolutions");
      if(btnS&&btnS.dataset.mode==="rejouer") btnS.click();
    }
  });
